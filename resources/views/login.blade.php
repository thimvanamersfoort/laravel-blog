    ...
    <div class="max-w-2xl mx-auto flex flex-col min-h-screen">
      ...
      <form action="/login" method="POST" class="mt-12 sm:max-w-[60%] space-y-8">
        ...
        <div class="relative border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
          <label for="name" class="absolute -top-3 left-2 -mt-px inline-block px-1 bg-white text-sm font-medium text-gray-700">Gebruikersnaam</label>
        ...
        <div class="relative border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
          <label for="password" class="absolute -top-3 left-2 -mt-px inline-block px-1 bg-white text-sm font-medium text-gray-700">Wachtwoord</label>
        ...
        <button type="submit" class="py-4 px-4 text-gray-700 bg-white font-medium rounded-xl border border-indigo-600 w-40 transition-all duration-150 focus:bg-indigo-600 focus:text-white hover:bg-indigo-600 hover:text-white">Inloggen</button>
